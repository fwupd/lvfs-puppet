...
cron { 'purgedelete':
    command => '/usr/lib/lvfs/env34/bin/python3 /var/www/lvfs/admin/cron.py purgedelete >> /var/log/uwsgi/lvfs-firmware.log 2>&1',
    user    => 'uwsgi',
    hour    => 0,
    minute  => 0,
...
cron { 'sign-firmware':
    command => '/usr/lib/lvfs/env34/bin/python3 /var/www/lvfs/admin/cron.py firmware >> /var/log/uwsgi/lvfs-firmware.log 2>&1',
    user    => 'uwsgi',
    hour    => '*',
    minute  => '*/5',
    require => Vcsrepo['/var/www/lvfs/admin'],
...
cron { 'fwchecks':
    command => '/usr/lib/lvfs/env34/bin/python3 /var/www/lvfs/admin/cron.py fwchecks >> /var/log/uwsgi/lvfs-firmware.log 2>&1',
    user    => 'uwsgi',
    hour    => '*',
    minute  => '*/5',
    require => Vcsrepo['/var/www/lvfs/admin'],
...
cron { 'sign-metadata':
    command => '/usr/lib/lvfs/env34/bin/python3 /var/www/lvfs/admin/cron.py firmware metadata >> /var/log/uwsgi/lvfs-metadata.log 2>&1',
    user    => 'uwsgi',
    hour    => '*',
    minute  => '*/30',
    require => Vcsrepo['/var/www/lvfs/admin'],
